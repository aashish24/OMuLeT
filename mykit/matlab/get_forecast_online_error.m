...
%                         error_mean(tau)=error_mean(tau)+get_distance(Y,predict_mean).^2;
%                         error_median(tau)=error_median(tau)+get_distance(Y,predict_median).^2;
%                         error_online(tau)=error_online(tau)+get_distance(Y,predict_online).^2;
%                         error_nhc(tau)=error_nhc(tau)+get_distance(Y,predict_nhc).^2;
...
%         error_mean=sqrt(error_mean./counts)/1.6;
%         error_median=sqrt(error_median./counts)/1.6;
%         error_online=sqrt(error_online./counts)/1.6;
%         error_nhc=sqrt(error_nhc./counts)/1.6;
...
%         if ii==4
%             error=mean(error_online(2:2:opts.beta))
%         end

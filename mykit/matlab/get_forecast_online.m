...
%                         P=zeros(1,opts.b);
%                         P(tau)=1;
%                         X=squeeze(forecast_tensor(h).X(t_r,tau,:,:));
%                         label=forecast_tensor(h).label(t_r,tau);
%                         Y=forecast_tensor(h).Y(label,:);
%                         C1=C1+opts.gamma^tau*(W*X-Y)*X';
%                         C2=C2+opts.gamma^tau*P'*(W*X-Y)*X';
                    end
                end
